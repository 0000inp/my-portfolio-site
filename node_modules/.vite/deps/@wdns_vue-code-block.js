...
// node_modules/@wdns/vue-code-block/dist/vue-code-block.es.js
...
`);
  ...
  function sn() {
    const a = (0, import_ua_parser_js.default)().device;
  ...
  function tn() {
    Sn(), e.value.highlightjs && import("./es-77ULASFB.js").then((a) => {
    ...
    }), e.value.prismjs && import("./prism-AJPMFJWW.js").then((a) => {
...
var bn = Object.freeze(Object.defineProperty({ __proto__: null, default: Un }, Symbol.toStringTag, { value: "Module" }));
var vn = Symbol();
function Qn(r = {}) {
  return { install: (t) => {
    t.provide(vn, r), t.component("CodeBlock", defineAsyncComponent(() => Promise.resolve().then(() => bn))), t.component("VCodeBlock", defineAsyncComponent(() => Promise.resolve().then(() => bn)));
  } };
}
(function() {
  "use strict";
...
@wdns/vue-code-block/dist/vue-code-block.es.js:
  (**
   ...
   *)
*/
//# sourceMappingURL=@wdns_vue-code-block.js.map
